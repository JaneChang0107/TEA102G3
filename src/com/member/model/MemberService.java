...
public class MemberService {
	...
	//修改會員建構子
	public MemberVO updateMem(String m_email,String m_name, String m_gender,String m_password, String m_phone,
	...
	//修改密碼
	public MemberVO updatepw(String m_password, String m_id) {
		MemberVO memberVO = new MemberVO();
		memberVO.setM_password(m_password);
		memberVO.setM_id(m_id);
