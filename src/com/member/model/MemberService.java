...
public class MemberService {
	...
	public MemberVO addMem(String m_email, String m_password, String m_name, String m_gender, String m_phone, String m_address,
	 java.sql.Date m_birth,	 byte[] m_headpic, Integer m_status, String m_identity, byte[] m_id_pic, String m_account, String m_accountName,
	 String b_code, byte[] m_bank_pic, String m_storename, String m_info, byte[] m_cover, String m_hi,
	 String m_offlineHi, Integer m_coin) {
	...
	public MemberVO updateMem(String m_id,String m_email, String m_password, String m_name, String m_gender, String m_phone, String m_address,
			 java.sql.Date m_birth,	 byte[] m_headpic, Integer m_status, String m_identity, byte[] m_id_pic, String m_account, String m_accountName,
			 String b_code, byte[] m_bank_pic, String m_storename, String m_info, byte[] m_cover, String m_hi,
			 String m_offlineHi, Integer m_coin) {
