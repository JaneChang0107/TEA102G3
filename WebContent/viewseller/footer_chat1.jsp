...
<!-- 		<input type="submit" value="聊聊"> <input type="hidden" -->
<%-- 			name="m_id" value="${memberID}"> <input type="hidden" --%>
<!-- 			name="action" value=""> -->
<!-- 	</form> -->

	<form action="<%=request.getContextPath()%>/websocketchat/NameServlet"
		method="POST">
...
// 			.setAttribute(
// 					'src',
// 					'https://client-chat.easychat.co/?appkey=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0ZWFtTmFtZSI6Ikt1biJ9.uOeo_lEPhWLQAXpDjxfFlgYzg4Eg2EgI1dKLLl4QXmc&lang=zh-Hant');
