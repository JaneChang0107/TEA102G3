...
.form-container,.container preload{
display:inline-block;}
</style>
					...
					<div class="collapse" id="collapseExample">
						...
						<div class="card-body">
							<table class="table2" width="100%">
								...
								<tr>
									<td><input type="radio" name="o_transport"
											id="delivery" value=0 required /><p align=center>黑貓宅急便</p></td>
									<td>130</td>
									<td><input type="radio" name="pay" value=6 id="paynow" required> <p align=center>貨到付款</p></td>
								</tr>
								<tr>
									<td><input type="radio" name="o_transport"
											id="delivery" value="1" /><p align=center>7-11</p></td>
									<td>60</td>
									<td><input type="radio" name="pay" value=7  id="credit"/><p align=center>信用卡</p></td>
								</tr>

								<tr>
									<td><input type="radio" name="o_transport"
											id="delivery" value="2" /><p align=center>全家</p></td>
									<td>60</td>
...
<td></td>
								...
								<tr>
									<td><input type="radio" name="o_transport"
											id="delivery" value="4" /><p align=center>萊爾富</p></td>
									<td>60</td>
<td></td>
								</tr>
								...
								<tr>
									<td><input type="radio" name="o_transport"
											id="delivery" value="5" /><p align=center>郵局</p></td>
									<td>70</td>
								...
								<tr>
									<td></td>
									<td></td>
									<td><input type="checkbox" id="checkbox"></input><p align=center>同訂購人資料</p>
									<td>
								</tr>
								<tr>
								<td colspan=2>
