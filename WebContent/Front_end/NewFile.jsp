...
<div class="fade">
  <div>
 <img class="d-block w-100" src="<%=request.getContextPath()%>/images/index3.png" alt="Third slide" width=1300px height=700px>
</div>
  <div>  
  <img class="d-block w-100" src="<%=request.getContextPath()%>/images/index2.png" alt="Second slide"  width=1300px height=700px></div>
  <div>          
  <img class="d-block w-100" src="<%=request.getContextPath()%>/images/index3.png" alt="Third slide" width=1300px height=700px>
</div>
</div>
...
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    ...
    <img src="<%=request.getContextPath()%>/images/index1.jpg" style="width:100%">
    <div class="text"></div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="<%=request.getContextPath()%>/images/index2.png" style="width:100%">
    <div class="text"></div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="<%=request.getContextPath()%>/images/index3.png" style="width:100%">
    <div class="text"></div>
  </div>
