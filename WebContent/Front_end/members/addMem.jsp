...
<!-- 		<font style="color: red">請修正以下錯誤:</font> -->
		...
		<label>
          ...
          <div id="seller">
		  <label><input type="checkbox" class="btn btn-primary"value="成為賣家" onclick="location.href='<%=request.getContextPath()%>/Front_end/members/addMemSeller.jsp'">我要成為賣家</label>
          </div>
