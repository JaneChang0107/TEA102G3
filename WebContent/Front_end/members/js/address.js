...
(function ($) {
    ...
    $.fn.twaddress = function () {
        this.each(function () {
            ...
            var $twcity = $('<select class="form-control" style="width:150px;display:inline-block;position:relative;right:35px;"></select>');
            var $twmore = $('<input type="text" class="form-control" placeholder="請輸入地址"></input>');
            ...
            $twcity.change(function () {
                var $new_twdist = $('<select class="form-control" style="width:150px;display:inline-block;position:relative;right:35px;"></select>');
