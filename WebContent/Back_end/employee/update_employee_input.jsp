...
<!-- 	</tr> -->
	<tr>
		...
		<td><select size="1" name="e_status">
				<option value="0" <%=employeeVO.getE_status()==0 ? "selected" : "" %>>在職
				<option value="1" <%=employeeVO.getE_status()==1 ? "selected" : "" %>>離職
				<option value="2" <%=employeeVO.getE_status()==2 ? "selected" : "" %>>留職停薪
		</select></td>
	</tr>
