...
<%
RentOrderVO rentOrderVO = (RentOrderVO) request.getAttribute("rentOrderVO");
%>
...
<table>
	...
	<tr>
		<td>訂單狀態:</td>
		<td><input type="TEXT" name="ro_status" size="45"
			 value="<%= (rentOrderVO==null)? "1" : rentOrderVO.getRo_status()%>" /></td>
	</tr>
	...
	<tr>
		<td>押金:</td>
		<td><input type="TEXT" name="ro_deposit" size="45"
			 value="<%= (rentOrderVO==null)? "10000" : rentOrderVO.getRo_deposit()%>" /></td>
	</tr>
	<tr>
		<td>總金額:</td>
		<td><input type="TEXT" name="ro_total" size="45"
			 value="<%= (rentOrderVO==null)? "100" : rentOrderVO.getRo_total()%>" /></td>
	</tr>	
	<tr>
		<td>電子簽名:</td>
	...
	<tr>
		<td>坤幣:</td>
		<td><input type="TEXT" name="ro_pm" size="45"
			 value="<%= (rentOrderVO==null)? "10000" : rentOrderVO.getRo_pm()%>" /></td>
	</tr>
...
<% 
  ...
  try {
	  ro_date = rentOrderVO.getRo_date();
   } catch (Exception e) {
	   ro_date = new java.sql.Timestamp(System.currentTimeMillis());
   }
%>
<% 
  java.sql.Timestamp ro_outdate = null;
  try {
	  ro_outdate = rentOrderVO.getRo_outdate();
   } catch (Exception e) {
	   ro_outdate = new java.sql.Timestamp(System.currentTimeMillis());
   }
%>
<% 
  java.sql.Timestamp ro_backdate = null;
  try {
	  ro_backdate = rentOrderVO.getRo_backdate();
   } catch (Exception e) {
	   ro_backdate = new java.sql.Timestamp(System.currentTimeMillis());
   }
%>
