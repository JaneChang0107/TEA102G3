...
<%
RentDetailVO rentDetailVO = (RentDetailVO) request.getAttribute("rentDetailVO");
%>
...
<table>
	...
	<tr>
		<td>產品數量:</td>
		<td><input type="TEXT" name="rd_count" size="45" placeholder="請輸入產品數量"
			 value="<%= (rentDetailVO == null) ? "5" : rentDetailVO.getRd_count()%>" /></td>
	</tr>
