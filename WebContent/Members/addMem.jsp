		...
		<table>
			<tr>
				...
				<td><input type="text" name="m_email" size="40"
					value="<%=(memberVO == null) ? "請填入郵箱" : memberVO.getM_address()%>" /></td>
			...
			<tr>
				...
				<td><input type="text" name="m_name" size="40"
					value="<%=(memberVO == null) ? "請填入姓名" : memberVO.getM_name()%>" /></td>
			</tr>
			<tr>
				<td>性別:<b>*</b></td>
				<td><input type="radio" name="m_gender" value="男">男 <input
					type="radio" name="m_gender" value="女">女</td>
			</tr>
			<tr>
				<td>電話:<b>*</b></td>
				<td><input type="text" name="m_phone" size="40"
					value="<%=(memberVO == null) ? "請填入電話" : memberVO.getM_phone()%>" /></td>
			</tr>
			<tr>
				<td>地址:<b>*</b></td>
			...
			<tr>
				...
				<td><input type="file" name="m_headpic"
					value="<%=(memberVO == null) ? "請上傳大頭照" : memberVO.getM_headpic()%>" /></td>
			</tr>
			<tr>
				<td>會員狀態:</td>
			...
			<tr>
				...
				<td><input type="text" name="m_identity"
					value="<%=(memberVO == null) ? "請填入身分證字號" : memberVO.getM_identity()%>"></td>
			</tr>
			<tr>
				<td>身分證照片:</td>
			...
			<tr>
				...
				<td><input type="text" name="m_account"
					value="<%=(memberVO == null) ? "請輸入銀行帳戶" : memberVO.getM_account()%>"></td>
			</tr>
			<tr>
				<td>銀行戶名:</td>
				<td><input type="text" name="m_accountname"
					value="<%=(memberVO == null) ? "請輸入銀行戶名" : memberVO.getM_accountName()%>"></td>
			</tr>
			<tr>
				<td>銀行代號:</td>
				<td><input type="text" name="b_code"
					value="<%=(memberVO == null) ? "請輸入銀行代號" : memberVO.getB_code()%>"></td>
			</tr>
			<tr>
				<td>存摺照片:</td>
				<td><input type="file" name="m_id_pic"
			...
			<tr>
				...
				<td><input type="text" name="m_storename"
					value="<%=(memberVO == null) ? "請輸入商場名字" : memberVO.getM_storename()%>"></td>
			</tr>
			<tr>
				<td>賣場簡介:</td>
				<td><input type="text" name="m_info"
					value="<%=(memberVO == null) ? "請輸入商場介紹" : memberVO.getM_info()%>"></td>
			</tr>
			<tr>
				<td>賣場封面:</td>
